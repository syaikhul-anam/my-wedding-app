...
export default function ShareButtons() {
  ...
  const shareText = 'Join us in celebrating our wedding!';
  ...
  const shareLinks = {
    ...
    email: `mailto:?subject=${encodeURIComponent(
      shareText
    )}&body=${encodeURIComponent(`Join us in celebrating our wedding! ${shareUrl}`)}`,
  };
  ...
  return (
    <div className="flex flex-wrap justify-center gap-4">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 bg-blue-400 text-white px-6 py-3 rounded-full hover:bg-blue-500 transition-colors"
      >
        <svg
          className="w-5 h-5"
          fill="currentColor"
